...
В части курса — [устройство JavaScript-движков](/docs/lexical_environment/js_engines.html), говорилось о том, что сначала исходный код программы последовательно анализируется и разбирается компилятором.
