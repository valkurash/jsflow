...
description: С появлением блочной области видимости в рамках каждого Контекста Выполнения теперь есть два Лексических Окружения вместо одного (LexicalEnvironment и VariableEnvironment).
order: 17
---
