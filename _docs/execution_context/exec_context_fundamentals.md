...
Подробнее об этом теге можно прочитать [здесь](/docs/intro/programm_launch/). Архив с уже готовыми исходными файлами доступен по [этой ссылке](/source_code/execution_context/empty_script_example.zip).
